...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/smart-account/challenge": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Key type and key reference",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.deployChallengeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/smart-account/ed25519": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Raw 32-byte Ed25519 public key, hex-encoded",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.deployEd25519Request"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/smart-account/g-address": {
            "post": {
                ...
                "description": "Deploys (or idempotently returns) the deterministic smart account whose\nsigner is a classic Stellar account — the Freighter / external-wallet path.\nTestnet only: this flow funds the signer via friendbot, which has no mainnet equivalent.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.deployGAddressRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/smart-account/multisig": {
            "post": {
                ...
                "description": "Deploys (or idempotently returns) the deterministic smart account for a\nsigner set and threshold. The signer order and salt are the client's and\nare used verbatim — both determine the resulting address.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Canonically ordered signers, threshold, and 32-byte salt",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.deployMultisigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/smart-account/webauthn": {
            "post": {
                ...
                "description": "Deploys (or idempotently returns) the deterministic smart account for a\npasskey's key data (P-256 public key + credential ID). The bundler pays the fee.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Hex-encoded P-256 public key + credential ID",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.deployWebauthnRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/transaction/submit": {
            "post": {
                ...
                "description": "Rebuilds the caller's invocation with the bundler as fee-paying source,\nre-simulates it in enforcing mode against the supplied auth entries, signs\nand submits. Used by latch-mobile for sends, swaps and admin operations.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Built transaction and signed auth entries",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.submitTransactionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_latch_backend_internal_service.PriceData": {
            "type": "object",
            "properties": {
                "change_24h": {
                    "description": "percentage, e.g. -1.23",
                    "type": "number"
                },
                "price": {
                    "description": "price in the requested currency as string, e.g. \"0.1423\"",
                    "type": "string"
                }
            }
        },
        ...
        "internal_handler.deployChallengeRequest": {
            "type": "object",
            "required": [
                "key_ref",
                "key_type"
        ...
        "internal_handler.deployEd25519Request": {
            "type": "object",
            "required": [
                "proof",
                "public_key_hex"
            ...
            "properties": {
                ...
                "proof": {
                    "$ref": "#/definitions/internal_handler.deployProof"
                },
                "public_key_hex": {
                    "type": "string"
                }
        ...
        "internal_handler.deployGAddressRequest": {
            "type": "object",
            "required": [
                "g_address",
                "proof"
        ...
        "internal_handler.deployMultisigRequest": {
            "type": "object",
            "required": [
                "proof",
                "proof_key_ref",
            ...
            "properties": {
                ...
                "proof_key_type": {
                    "description": "ProofKeyType/ProofKeyRef identify which signer in the set is proving\npossession — the deploying device. It must be one of Signers.",
                    "type": "string"
                },
                "salt_hex": {
                    "type": "string"
                ...
                "signers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.deployMultisigSigner"
                    }
                },
                "threshold": {
                    "type": "integer"
        ...
        "internal_handler.deployMultisigSigner": {
            "type": "object",
            "required": [
                "type"
            ],
            "properties": {
                "g_address": {
                    "description": "GAddress is the classic Stellar account, for \"delegated\" only.",
                    "type": "string"
                },
                "key_data_hex": {
                    "description": "KeyDataHex carries the raw Ed25519 public key or the passkey key data,\ndepending on Type. Empty for \"delegated\".",
                    "type": "string"
                },
                "type": {
                    "description": "Type is \"ed25519\", \"webauthn\", or \"delegated\".",
                    "type": "string"
                }
            }
        },
        "internal_handler.deployProof": {
            "type": "object",
            "required": [
                "nonce",
                "signature"
            ...
            "properties": {
                "authenticator_data": {
                    "description": "WebAuthn assertion parts — passkey deploys only.",
                    "type": "string"
                },
                "client_data_json": {
                    "type": "string"
        ...
        "internal_handler.deployWebauthnRequest": {
            "type": "object",
            "required": [
                "key_data_hex",
                "proof"
        ...
        "internal_handler.pricesDataResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/github_com_latch_backend_internal_service.PriceData"
                    }
                }
            }
        },
        ...
        "internal_handler.submitTransactionRequest": {
            "type": "object",
            "required": [
                "auth_entries",
                "tx_xdr"
            ...
            "properties": {
                "auth_entries": {
                    "description": "AuthEntries are base64 SorobanAuthorizationEntry XDRs the client already\nsigned with the user's key.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "tx_xdr": {
                    "description": "TxXdr is the client-built, simulated transaction. Only its host function\nis used; the envelope itself is discarded and rebuilt.",
                    "type": "string"
                }
            }
        },
